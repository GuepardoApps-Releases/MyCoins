...
internal class CoinAdapterHolder(var coin: Coin, var currency: Currency, private var coinConversion: CoinConversion?) {
    ...
    fun totalValue(): Double = if (coinConversion == null) 0.0 else when (currency) {
        Currency.EUR -> coinConversion!!.eurValue * coin.amount
        Currency.USD -> coinConversion!!.usDollarValue * coin.amount
    }
